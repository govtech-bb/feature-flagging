...
- Node.js 20+
- pnpm 9.10+
- A running instance of [form-processor-api](../form-processor-api)
- An Airtable base with the service catalogue table (see env vars below)
...
| `VITE_AIRTABLE_BASE_ID` | Airtable base ID (from the base URL: `airtable.com/appXXXXXXXXXXXXXX`) |
| `VITE_AIRTABLE_TABLE_NAME` | Name of the Airtable table holding the service catalogue (e.g. `Services`) |
| `VITE_AIRTABLE_TOKEN` | Airtable personal access token — scope to read-only on this base only |
